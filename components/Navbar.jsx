        ...
        <div className="mx-auto flex h-[60px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1">
            <a
              ...
              className="group inline-flex items-center gap-1.5 rounded-lg bg-rose-600 px-3.5 py-1.5 text-[11px] font-bold text-white tracking-wide uppercase hover:bg-rose-500 transition-all duration-200 shadow-[0_0_16px_rgba(225,29,72,0.3)]"
            >
              {/* Kick icon */}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[11px] font-semibold text-white/50 hover:text-white hover:bg-white/[0.06] transition-all duration-200 uppercase tracking-wide"
            >
              <svg className="h-3 w-3 fill-current" viewBox="0 0 24 24" aria-hidden="true">
