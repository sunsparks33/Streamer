        ...
        <div className="mx-auto flex h-[60px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[11px] font-semibold text-red-500 hover:text-red-400 hover:bg-red-500/[0.08] transition-all duration-200 uppercase tracking-wide"
            >
              <svg className="h-3 w-3 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[11px] font-semibold text-[#5865F2] hover:text-[#7983f5] hover:bg-[#5865F2]/[0.08] transition-all duration-200 uppercase tracking-wide"
            >
              <svg className="h-3 w-3 fill-current" viewBox="0 0 24 24" aria-hidden="true">
