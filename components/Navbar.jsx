        ...
        <div className="mx-auto flex h-[60px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-1">
            <a
              ...
              className="group inline-flex items-center gap-1.5 rounded-lg bg-[#53FC18] px-3.5 py-1.5 text-[11px] font-bold text-black tracking-wide uppercase transition-all duration-200 shadow-[0_0_16px_rgba(83,252,24,0.3)] hover:bg-[#6dff35] hover:-translate-y-0.5 hover:scale-[1.06] hover:shadow-[0_0_28px_rgba(83,252,24,0.55)] active:scale-[0.97] active:translate-y-0"
            >
              <svg className="h-3 w-3 fill-current transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1.5 rounded-lg bg-red-600 px-3.5 py-1.5 text-[11px] font-bold text-white tracking-wide uppercase transition-all duration-200 shadow-[0_0_14px_rgba(239,68,68,0.3)] hover:bg-red-500 hover:-translate-y-0.5 hover:scale-[1.06] hover:shadow-[0_0_26px_rgba(239,68,68,0.55)] active:scale-[0.97] active:translate-y-0"
            >
              <svg className="h-3 w-3 fill-current transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1.5 rounded-lg bg-[#5865F2] px-3.5 py-1.5 text-[11px] font-bold text-white tracking-wide uppercase transition-all duration-200 shadow-[0_0_14px_rgba(88,101,242,0.35)] hover:bg-[#6d78f5] hover:-translate-y-0.5 hover:scale-[1.06] hover:shadow-[0_0_26px_rgba(88,101,242,0.6)] active:scale-[0.97] active:translate-y-0"
            >
              <svg className="h-3 w-3 fill-current transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" aria-hidden="true">
